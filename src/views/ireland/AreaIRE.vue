<template>
<h2 id="categories_title"><router-link to="/ireland" @click="goBack()"><i id="back" title="Back to Areas" class="fa-solid fa-circle-arrow-left" ></i></router-link>
...
<!-- Lista risorse -->
  <div class="resources">
    <p v-if="empty" id="emptyMsg">No Resources found in this Area</p>
